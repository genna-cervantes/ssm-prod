...
const NOTES_DATA = [
  {
    date: "Oct 8, 2025",
    quote:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet, adipisci dignissimos aliquid accusamus nesciunt consectetur atque rem eos, placeat, id corrupti cupiditate laborum quo facilis quidem magnam distinctio similique optio!.",
    author: "Anonymous",
  },
  {
    date: "Oct 9, 2025",
  ...
  },
  {
    date: "Oct 10, 2025",
    quote:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet, adipisci dignissimos aliquid accusamus nesciunt consectetur atque rem eos",
    author: "Anonymous",
  },
  {
    date: "Oct 11, 2025",
...
const REASON_CARDS = [
  {
    ...
    description:
      "The Sierra Madre is our first line of defense against typhoons in the Philippines as it weakens the strong winds and heavy rain. Without it, storms would continue to cause greater destruction to countless homes, farms, and infrastructures, pushing us to an impoverished life.",
  },
  {
    title: "Prevents Landslide and Floods",
    description:
      "The healthy forests surrounding the Sierra Madre help hold the soil in the land in place. There are tree roots that prevent erosion and keep the ground stable, which further prevents the risk of landslides.",
  },
  {
    title: "Provides Water For Luzon",
    description:
      "It sustains the needs for millions of Filipinos, with means of living such as agriculture, fisheries, and household. The region 3, where Sierra Madre spans across, accounts for the highest share in the total agricultural output at 16%.",
  },
  {
    title: "Home to Indigenous Communities",
    description:
      "It serves as home and history to Indigenous communities such as the Agta, Dumagat, and Remontado, who have lived in the mountain range for centuries. Honoring their rights means protecting their home and source of identity.",
  },
];
    ...
    <div className="w-full font-sans">
      ...
      <section className="relative min-h-screen flex flex-col items-center overflow-hidden">
        <div className="absolute inset-0 -z-20">
          <Image
            ...
            alt="Bg"
            fill
            className="object-cover object-center md:object-top mt-30"
            priority
          />
        </div>
        ...
        <div className="flex flex-col w-full grow mx-auto px-4 relative z-10">
          <div className="grow flex flex-col items-center justify-center text-center gap-8 md:gap-10 pt-10 pb-10">
            <div className="hero-title space-y-2 md:space-y-4">
              <p className="text-xl md:text-3xl font-medium text-gray-700 tracking-wide">
              ...
              <p className="text-lg md:text-3xl text-gray-700 font-medium">
                Without it, our future is at risk
              </p>
            </div>
            <div className="hero-cta flex  flex-row gap-4 w-full sm:w-auto mt-4">
              <button className="bg-green-6 text-white px-1.5 lg:px-8 py-4 rounded-xl text-s text-m lg:text-lg hover:bg-[#3a583a] transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 w-full sm:w-auto">
                Sign the petition now
              </button>
              <button className="bg-white/80 backdrop-blur-2xl text-black lg:px-12 py-4 rounded-xl text-s lg:text-lg hover:bg-green-600 hover:text-white transition-all w-3/4 sm:w-auto">
                Learn more
              </button>
            </div>
          </div>
          ...
          <div className="w-full flex flex-col items-center pb-10 mt-10 md:pb-20 gap-10">
            <div className="w-full md:grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-4 text-center px-4 md:px-0 hidden">
              <div className="flex flex-col items-center justify-end gap-2">
                <p className="text-green-6 text-lg md:text-xl font-medium drop-shadow-md">
                  The lungs of Luzon
                </p>
              ...
              <div className="flex flex-col items-center justify-end gap-2 md:-mt-12">
                <p className="text-green-6 text-lg md:text-xl font-medium drop-shadow-md max-w-[300px]">
                  Home to millions of species and indigenous communities.
                </p>
                <div className="h-12 md:h-32 w-px border-l-2 border-dashed border-green-6/70"></div>
                <div className="w-3 h-3 bg-green-6 rounded-full shadow-[0_0_10px_green-6]"></div>
              </div>
              <div className="flex flex-col items-center justify-end gap-2">
                <p className="text-green-6 text-lg md:text-xl font-medium drop-shadow-md max-w-[250px]">
                  Protector from typhoons, and provider of clean water
                </p>
      ...
      <main>
        ...
        <section className="w-full min-h-screen relative py-10 md:py-[100px] px-4 md:px-[50px] bg-white">
          ...
          <header className="header-container pt-50 w-full py-8 flex flex-col items-center pb-20 text-green-7 justify-center text-center">
            ...
            <p className="mt-2 text-lg text-brown-3">
              This ancient rainforest is more than just trees. It's a lifeline
              for millions.
            </p>
          </header>
        ...
        <section className="problem min-h-screen bg-linear-to-b from-[#1A2F1A] to-[#396839] pt-20 flex flex-col w-full items-center justify-start gap-16 text-white">
          <div className="problem-title flex flex-col items-center text-center px-4">
            <h2 className="text-4xl md:text-7xl font-bold mb-6 leading-tight">
              But Sierra Madre is{" "}
              <span className="text-red-400">Under Threat</span>
            </h2>
            <p className="text-lg md:text-2xl text-gray-200 max-w-5xl leading-relaxed mb-10">
              The Sierra Madre faces severe threats from illegal logging,
              mining, destructive agricultural practices, and infrastructure
              projects, which together cause forest degradation, loss of
              biodiversity, and weaken its vital role as a natural barrier
              protecting communities from storms.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center w-full">
              <button className="bg-white text-black px-12 py-4 lg:px-20 rounded-xl text-lg font-bold hover:bg-gray-200 transition-colors shadow-lg flex items-center text-center justify-center">
                Read more <ChevronRight />{" "}
              </button>
              <button className="bg-transparent border-white border-2 px-12 lg:px-20 text-white py-4 rounded-xl text-lg font-bold hover:bg-white hover:text-black transition-colors flex items-center gap-2 text-center justify-center">
                Listen <Volume2 />
              </button>
            </div>
          </div>
          ...
          <div className="w-full flex flex-col shadow-2xl mx-auto">
            <div className="relative w-full h-[600px] md:h-[700px] bg-gray-900 overflow-hidden group">
              <Image
                src="/images/kaliwa-dam-main-pic.jpg"
                alt="Construction of Kaliwa Dam"
                fill
              ...
              <div className="absolute top-1/2 left-1/2 md:left-1/3 -translate-x-1/2 md:translate-x-0 -translate-y-1/2 flex flex-col items-center z-10 w-3/4 md:w-max">
                <div className="bg-black/40 backdrop-blur-md border border-white/20 p-6 rounded-2xl text-center shadow-xl">
                  <p className="text-white italic text-sm md:text-lg leading-relaxed">
                    "Construction of the <br />{" "}
                    <span className="italic">KALIWA DAM</span> <br /> (captured
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 bg-gray-800 gap-px border-t border-gray-800">
              {KALIWA_STATS.map((stat, idx) => (
                <div
                  key={idx}
                  className="relative w-full h-[200px] md:h-[250px] bg-black group overflow-hidden"
                >
                  <Image
                    src="/images/kaliwa-dam-sub-pic.jpg"
                    alt="bg"
                    fill
                  ...
                  <div className="relative z-10 h-full flex flex-col items-center justify-center p-4 text-center">
                    ...
                    <p className="text-gray-300 uppercase tracking-widest text-xs md:text-sm font-semibold">
                      {stat.label}
                    </p>
                  </div>
                </div>
        ...
        <section className="why-we-must-act-now-div w-full min-h-screen py-10 md:py-[100px] px-4 md:px-[50px] bg-[#FFFCF5]">
          <h1 className="text-green-6 text-4xl md:text-[72px] font-bold flex items-center justify-center m-8 md:m-14 text-center">
            Why Must We Act Now
          </h1>
          ...
          <div>
            <h1 className="title-divider font-semibold text-[24px] leading-8 my-8 text-green-6">
        ...
        <section className="voice-section flex flex-col lg:flex-row w-full min-h-screen lg:h-screen bg-[#395739]">
          <div className="voice-content flex-1 flex flex-col justify-center items-start px-6 md:px-12 lg:px-20 py-12 lg:py-0 text-white order-1 lg:order-2">
            <h1 className="text-4xl md:text-5xl lg:text-7xl mb-6">
              Your{" "}
              <span className="bg-linear-to-r from-[#ffffff] to-[#A3CB5B] bg-clip-text text-transparent">
                Voice
              </span>{" "}
              Can
              <br />
            ...
            <p className="text-base md:text-lg mb-8 max-w-2xl leading-relaxed text-brown-2">
              Join thousands of concerned citizen, environmental advocates, and
              community leaders in calling for the protection of Sierra Madre.
              Together, we can ensure this vital ecosystem is preserved for
              future generations.
            </p>
            ...
            <p className="text-base md:text-xl font-serif italic opacity-90 text-brown-2">
              Every signature brings us closer to protecting Sierra Madre. Share
              the petition with your family and friends.
            </p>
          </div>
          <div className="voice-img-container relative w-full h-[600px] lg:w-[45%] lg:h-full order-2 lg:order-1">
            <img
              className="h-full w-full object-cover grayscale rounded-tr-[200px]"
              src="/images/voice-img.jpg"
              alt=""
            />
        ...
        <section className="cta-3-section relative py-24 bg-green-1 flex flex-col items-center justify-center overflow-hidden">
          <div className="cta-3-text text-center mb-10 px-4 flex flex-col items-center w-full">
            ...
            <p className="text-xl text-black max-w-2xl mx-auto font-serif italic">
              Read what others are saying about Sierra Madre and share your own
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
                  className="text-brown-2 hover:text-white transition-colors"
                >
                  About SSMNAI
                </a>
              </li>
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            ...
            <ul className="space-y-3 text-brown-2 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Rm. 232, St. Anthony Bldg. 891 Aurora Boulevard cor. Cambridge
                  Street, Cubao 1112 Quezon City
                </span>
              </li>
